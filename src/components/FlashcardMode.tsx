    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] max-w-xl mx-auto space-y-8">
      ...
      <div className="relative w-full min-h-[400px]" style={{ perspective: "1000px" }}>
        ...
        >
            ...
            >
                <Card className="w-full h-full min-h-[400px] flex flex-col items-center justify-center p-6 sm:p-8 text-center bg-card border-l-4 border-l-primary shadow-xl relative">
                    <span className="text-sm uppercase tracking-widest text-muted-foreground mb-4">Sual</span>
                    <h3 className="text-lg sm:text-xl font-bold leading-relaxed mb-6">{currentCard.question}</h3>

...
const questions = [
    ...
    },
    {
        ...
        "answer": "Qadınların bədən proporsiyaları yaşla dəyişir. Yeniyetməlikdə boy artır, gənclikdə (20-29 yaş) bədən formalaşır. 30-45 yaşlarında çəki artımı və bədən dolğunluğu müşahidə olunur. Yaşlılıqda boy qısalması və dəri elastikliyinin itirilməsi baş verir.",
        "category": "Antropometriya"
    },
    {
        "id": 31,
    ...
    },
    {
        ...
        "answer": "Somatoqrafiya insan bədəninin və iş yerinin ölçü nisbətlərini qrafik təsvir etmək metodudur. Məqsədi erqonomik uyğunluğu təmin etməkdir. Texniki vasitələr: sxemlər, çertyojlar, miqyaslı manekenlər (şablonlar) və onların iş yerinin planında təsviridir.",
        "category": "Tədqiqat metodları"
    },
    {
        "id": 60,
...
fs.writeFileSync('src/data/erqonomika-suallari.json', JSON.stringify(data, null, 2), 'utf8');
console.log("Updated erqonomika-suallari.json (Node.js version).");
